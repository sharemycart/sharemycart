...
import {
  IonButton, IonContent, IonFooter, IonToolbar, IonPage, IonHeader, IonTitle, IonCard, IonCardHeader, IonCardTitle,
} from '@ionic/react';
...
class NeedsInSharedShoppingList extends Component {
  ...
  render() {
    const {
      loading, shoppingListId, sharingUser, isValid,
    } = this.state;
...
&nbsp;(
                      ...
                      <Trans>has shared a shopping list with you</Trans>
                    </IonCardTitle>
                  </IonCardHeader>
                </div>
              </IonCard>
