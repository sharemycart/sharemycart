...
const resources = {
	en: {
		translation: {
			...
			'pwa_install_1': 'Install ShareMyCart as app on your',
			'pwa_install_2': 'tap',
			'pwa_install_3': 'and then "Add to Home Screen"',
			'Quantity': 'Quantity',
	...
	de: {
		translation: {
			...
			'pwa_install_1': 'Installiere ShareMyCart auf Deinem',
			'pwa_install_2': 'Klicke auf',
			'pwa_install_3': 'und dann auf "Zum Home-Bildschirm"',
			'Quantity': 'Menge',
